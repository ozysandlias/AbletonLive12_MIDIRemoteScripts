...
SESSIONUP = 41  # Session up
SESSIONDOWN = 37  # Session down
...
# Track Navigation
TRACKLEFT = 36  # Track left
TRACKRIGHT = 38  # Track right

# Scene Navigation
SCENEUP = 41  # Scene down
SCENEDN = 37  # Scene up
...
TEMPO_TOP = 220  # Upper limit of tempo control in BPM (max is 999)
TEMPO_BOTTOM = 70  # Lower limit of tempo control in BPM (min is 0)

TEMPOCONTROL = 23  # Tempo control CC assignment; control range is set above
