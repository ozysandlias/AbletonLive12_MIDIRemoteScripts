...
class nanoKEY_Studio_Bluetooth(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for nanoKEY_Studio_Bluetooth in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in nanoKEY_Studio_Bluetooth._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in nanoKEY_Studio_Bluetooth._active_instances:    # Make sure you update the name
            nanoKEY_Studio_Bluetooth._active_instances.append(self)   # Make sure you update the name
            nanoKEY_Studio_Bluetooth._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in nanoKEY_Studio_Bluetooth._active_instances) and nanoKEY_Studio_Bluetooth._active_instances.remove(self):    # Make sure you update the name
